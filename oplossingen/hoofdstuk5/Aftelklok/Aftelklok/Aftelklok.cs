...
namespace Aftelklok
{
    ...
    {
        private int _minutenStart;
        private int _secondenStart;
        ...
        public Aftelklok(int minuten, int seconden)
        {
            _minuten = minuten;
            _seconden = seconden;
            _minutenStart = minuten;
            _secondenStart = seconden;
        }
        ...
        public void OpStarttijd()
        {
            TijdInstellen(_minutenStart, _secondenStart);
        }
